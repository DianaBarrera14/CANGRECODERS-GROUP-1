  ...
  /* Future post
    ...
    putStudent = async () => {
      await axios
        ...
        .then((response) => {
          if (response) {
            cookies.set("id", response.userid, { path: "/alumnos" });
            cookies.set("cedula", response.cedula, { path: "/alumnos" });
            cookies.set("name", response.name, { path: "/ualumnos" });
            cookies.set("lastName", response.lastName, { path: "/alumnos" });
